...
# Agility Plaza URLs
PLAZA_RESULTS = "https://www.agilityplaza.com/results/"
PLAZA_BASE = "https://www.agilityplaza.com"
...
REMOVED_WORDS = [
    'DTC', 'Dog', 'Training', 'Society', 'and', '&', 
    'Club', 'in', 'In', 'Obedience', '(Dorset)', 
    'District', '(Lancs)', 'Show', 'Championship', 'agility'
]
